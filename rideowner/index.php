...
<?php
include'partials/ownerheader.php';
?>
<body>
...
<div class="container" x-data="{ rightSide: false, leftSide: false }">
  ...
  <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z"/>
    ...
    <div class="side-wrapper">
      <div class="side-title"><strong>Book a ride</strong></div>
      <div class="side-menu">
        <a href="#">
...
<ellipse transform="matrix(0.2551 -0.9669 0.9669 0.2551 -128.2296 477.9455)" style="fill:#E5E5E5;" cx="246.084" cy="322.197" rx="46.599" ry="33.9"/>
<ellipse transform="matrix(0.2551 -0.9669 0.9669 0.2551 -126.8133 479.7774)" style="fill:#B2B1B1;" cx="247.981" cy="322.194" rx="28.5" ry="20.8"/>
<ellipse transform="matrix(0.2551 -0.9669 0.9669 0.2551 -128.2296 477.9455)" style="fill:#EA4949;" cx="246.084" cy="322.197" rx="24.5" ry="17.9"/>
<ellipse transform="matrix(0.2551 -0.9669 0.9669 0.2551 -126.8059 479.787)" style="fill:#4F4B4B;" cx="247.991" cy="322.194" rx="10.5" ry="7.6"/>
<ellipse transform="matrix(0.2551 -0.9669 0.9669 0.2551 52.9632 596.9249)" style="fill:#E5E5E5;" cx="413.901" cy="264.088" rx="19.3" ry="14.1"/>
<ellipse transform="matrix(0.2551 -0.9669 0.9669 0.2551 53.5332 597.6931)" style="fill:#B2B1B1;" cx="414.685" cy="264.102" rx="11.8" ry="8.6"/>
<ellipse transform="matrix(0.2551 -0.9669 0.9669 0.2551 52.9729 596.9175)" style="fill:#EA4949;" cx="413.901" cy="264.078" rx="10.2" ry="7.4"/>
<ellipse transform="matrix(0.2551 -0.9669 0.9669 0.2551 53.5578 597.7049)" style="fill:#4F4B4B;" cx="414.705" cy="264.092" rx="4.3" ry="3.2"/>
...
<path style="fill:#D33C3C;" d="M197.6,196.2l-159,26.9c0,0-1,18,4.5,24.8c4.3,5.3,9.8,7.9,15.8,6.2c0,0,27.7-34.4,82.4-44.9
	L197.6,196.2z"/>
<ellipse transform="matrix(-0.112 -0.9937 0.9937 -0.112 -177.2068 316.2502)" style="fill:#FFFDF6;" cx="52.701" cy="237.303" rx="11" ry="10.1"/>
...
<path style="fill:#D33C3C;" d="M346.8,223.8l-173.1,39.1c0,0-4.2,20.4,4.4,28.1c5.6,5,11.2,8,17.7,5.8c0,0,28.1-39.5,87.4-54.6
	L346.8,223.8z"/>
<ellipse transform="matrix(-0.1706 -0.9853 0.9853 -0.1706 -54.6351 511.3808)" style="fill:#FFFDF6;" cx="187.906" cy="278.685" rx="12.1" ry="11.1"/>
...
<g>
        ...
        <a href="#">
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 413.709 413.709" style="enable-background:new 0 0 413.709 413.709;" xml:space="preserve">
<g>
	<g>
...
<g>
        ...
        <a href="#">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 32 32" viewBox="0 0 32 32"><defs><linearGradient id="a"><stop offset="0" stop-color="#000092"/><stop offset="1" stop-color="#ff00f3"/></linearGradient><linearGradient id="b" x1="2" x2="26" y1="16" y2="16" gradientUnits="userSpaceOnUse" xlink:href="#a"/></defs><path fill="url(#b)" d="M 8.6933594 4.5 C 7.4653594 4.5 6.4295156 5.3798437 6.2285156 6.5898438 L 5.9101562 8.5 L 3.5 8.5 C 2.673 8.5 2 9.173 2 10 L 2 11 C 2 11.827 2.673 12.5 3.5 12.5 L 5.2421875 12.5 L 5.0683594 13.544922 C 3.8953594 13.749922 3 14.769 3 16 L 3 22 L 3 23 C 3 23.651 3.419 24.201203 4 24.408203 L 4 26 C 4 26.827 4.673 27.5 5.5 27.5 L 7.5 27.5 C 8.327 27.5 9 26.827 9 26 L 9 24.408203 C 9.581 24.201203 10 23.651 10 23 L 10 22.5 L 22 22.5 L 22 23 C 22 23.651 22.419 24.201203 23 24.408203 L 23 26 C 23 26.827 23.673 27.5 24.5 27.5 L 26.5 27.5 C 27.327 27.5 28 26.827 28 26 L 28 24.408203 C 28.581 24.201203 29 23.651 29 23 L 29 22 L 29 16 C 29 14.769 28.104641 13.749922 26.931641 13.544922 L 26.757812 12.5 L 28.5 12.5 C 29.327 12.5 30 11.827 30 11 L 30 10 C 30 9.173 29.327 8.5 28.5 8.5 L 26.089844 8.5 L 25.771484 6.5898438 C 25.570484 5.3798437 24.533641 4.5 23.306641 4.5 L 8.6933594 4.5 z M 8.6933594 5.5 L 15.5 5.5 L 15.5 6.5 L 14.5 6.5 C 14.224 6.5 14 6.724 14 7 C 14 7.276 14.224 7.5 14.5 7.5 L 17.5 7.5 C 17.776 7.5 18 7.276 18 7 C 18 6.724 17.776 6.5 17.5 6.5 L 16.5 6.5 L 16.5 5.5 L 23.306641 5.5 C 24.042641 5.5 24.664156 6.0279063 24.785156 6.7539062 L 25.910156 13.5 L 25 13.5 L 7 13.5 L 6.0898438 13.5 L 7.2148438 6.7539062 C 7.3358438 6.0279063 7.9573594 5.5 8.6933594 5.5 z M 3.5 9.5 L 5.7421875 9.5 L 5.4101562 11.5 L 3.5 11.5 C 3.225 11.5 3 11.275 3 11 L 3 10 C 3 9.725 3.225 9.5 3.5 9.5 z M 26.257812 9.5 L 28.5 9.5 C 28.775 9.5 29 9.725 29 10 L 29 11 C 29 11.275 28.775 11.5 28.5 11.5 L 26.589844 11.5 L 26.257812 9.5 z M 5.5 14.5 L 6.7207031 14.5 L 10.279297 20.263672 C 10.371297 20.410672 10.532078 20.5 10.705078 20.5 L 21.294922 20.5 C 21.467922 20.5 21.628703 20.410672 21.720703 20.263672 L 25.279297 14.5 L 26.5 14.5 C 27.327 14.5 28 15.173 28 16 L 28 22 L 28 23 C 28 23.275 27.775 23.5 27.5 23.5 L 23.5 23.5 C 23.225 23.5 23 23.275 23 23 L 23 22.5 L 23.5 22.5 C 23.776 22.5 24 22.276 24 22 C 24 21.724 23.776 21.5 23.5 21.5 L 8.5 21.5 C 8.224 21.5 8 21.724 8 22 C 8 22.276 8.224 22.5 8.5 22.5 L 9 22.5 L 9 23 C 9 23.275 8.775 23.5 8.5 23.5 L 4.5 23.5 C 4.225 23.5 4 23.275 4 23 L 4 22 L 4 16 C 4 15.173 4.673 14.5 5.5 14.5 z M 7.8964844 14.5 L 24.103516 14.5 L 21.015625 19.5 L 10.984375 19.5 L 7.8964844 14.5 z M 5.5 16.5 C 5.224 16.5 5 16.724 5 17 L 5 20 C 5 20.276 5.224 20.5 5.5 20.5 L 8.5 20.5 C 8.685 20.5 8.8534531 20.398328 8.9394531 20.236328 C 9.0274531 20.073328 9.0180156 19.876656 8.9160156 19.722656 L 6.9160156 16.722656 C 6.8230156 16.583656 6.667 16.5 6.5 16.5 L 5.5 16.5 z M 13 16.5 C 12.724 16.5 12.5 16.724 12.5 17 L 12.5 18 C 12.5 18.276 12.724 18.5 13 18.5 C 13.276 18.5 13.5 18.276 13.5 18 L 13.5 17 C 13.5 16.724 13.276 16.5 13 16.5 z M 15 16.5 C 14.724 16.5 14.5 16.724 14.5 17 L 14.5 18 C 14.5 18.276 14.724 18.5 15 18.5 C 15.276 18.5 15.5 18.276 15.5 18 L 15.5 17 C 15.5 16.724 15.276 16.5 15 16.5 z M 17 16.5 C 16.724 16.5 16.5 16.724 16.5 17 L 16.5 18 C 16.5 18.276 16.724 18.5 17 18.5 C 17.276 18.5 17.5 18.276 17.5 18 L 17.5 17 C 17.5 16.724 17.276 16.5 17 16.5 z M 19 16.5 C 18.724 16.5 18.5 16.724 18.5 17 L 18.5 18 C 18.5 18.276 18.724 18.5 19 18.5 C 19.276 18.5 19.5 18.276 19.5 18 L 19.5 17 C 19.5 16.724 19.276 16.5 19 16.5 z M 25.5 16.5 C 25.333 16.5 25.176984 16.583656 25.083984 16.722656 L 23.083984 19.722656 C 22.980984 19.875656 22.972547 20.073328 23.060547 20.236328 C 23.147547 20.398328 23.316 20.501953 23.5 20.501953 L 26.5 20.501953 C 26.776 20.501953 27 20.277953 27 20.001953 L 27 17.001953 C 27 16.725953 26.776 16.501953 26.5 16.501953 L 25.5 16.501953 L 25.5 16.5 z M 6 17.5 L 6.2324219 17.5 L 7.5644531 19.5 L 6 19.5 L 6 17.5 z M 25.767578 17.5 L 26 17.5 L 26 19.5 L 24.435547 19.5 L 25.767578 17.5 z M 5 24.5 L 6 24.5 C 6 24.776 6.224 25 6.5 25 C 6.776 25 7 24.776 7 24.5 L 8 24.5 L 8 26 C 8 26.275 7.775 26.5 7.5 26.5 L 7 26.5 C 7 26.224 6.776 26 6.5 26 C 6.224 26 6 26.224 6 26.5 L 5.5 26.5 C 5.225 26.5 5 26.275 5 26 L 5 24.5 z M 24 24.5 L 25 24.5 C 25 24.776 25.224 25 25.5 25 C 25.776 25 26 24.776 26 24.5 L 27 24.5 L 27 26 C 27 26.275 26.775 26.5 26.5 26.5 L 26 26.5 C 26 26.224 25.776 26 25.5 26 C 25.224 26 25 26.224 25 26.5 L 24.5 26.5 C 24.225 26.5 24 26.275 24 26 L 24 24.5 z "/></svg>
    ...
    <div class="main-container">
      <div class="profile">
        <div class="profile-avatar">
          <img src="../assets/img/profiles/2.png"  alt="" class="profile-img">
          <div class="profile-name">Quan Ha</div>
        </div>
        <img src="../cars/sports/1.jpeg"  alt="" class="profile-cover">
        <div class="profile-menu">
         
          <a class="profile-menu-link">My Posts</a>
  ...
  <div class="right-side" :class="{ 'active': rightSide }">
    <div class="account">
      ...
      <span class="account-user">Quan Ha
        <img src="../assets/img/profiles/2.png" alt="" class="account-profile" alt="">
        <span>▼</span>
      </span>
    </div>
...
<?php
include'partials/ownerfooter.php';
?>